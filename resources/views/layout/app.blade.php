           ...
           <a> <img class="logo" src="{{ asset('img/mmsulogo1.png') }}" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <li class="nav-item active">
                    <a class="nav-link" style="color:white" href="/projects">Accomplishment Report </a>
                </li>
                </ul>
                ...
                <footer>
                    <div class="footer" >
                            ...
                            <h6><small>Ttestb</small></h6>
                            <h6><small>+69 915 972 4983</small></h6>
                            <h6><small>imbusco@gmail.com</small></h6>
